<html>
    <head>
        <title>PROJECT S&Iacute;SIFO</title>
    ...
    <body class="bg-dark" style="max-width: 100%">
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container" style="width: 450px">
                <a class="navbar-brand fs-4"  style="font-family: Consolas" href="{{route('inicio')}}">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown" style="padding-right: 20px">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                <li><a class="dropdown-item" href="{{route('inicio')}}">Home</a></li>
                                <li><a class="dropdown-item disabled" href="#">Pr&aacute;cticas</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li align="center"><a href="{{route('login')}}"><button type="button" class="btn btn-warning fs-5">LOGIN</button></a></li>
                            </ul>
                        </li>
                        <li>
    ...
    <footer class="text-center text-white fixed-bottom bg-dark">
        <div class="text-center p-3" style="background-color: rgba(0,0,0,0.1)">
            @2021
            <a class="text-white" href="http://t.me/caronte11">Alexis Ceballos.</a>
        </div>
    </footer>
